...
const DemoProduct = (props) => {
  ...
  function sendEmail(e) {
    ...
    document.getElementById("submitBtn").innerHTML = forms.demo.loadingText
    ...
    axios({
      ...
      .then((response) => {
        ...
        document.getElementById("submitBtn").innerHTML = forms.demo.submitText.toLowerCase()
        clearInput()
        //handle success
        ...
        <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
          <form onSubmit={sendEmail} id="demoProductForm">
            <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              ...
              {forms.demo.products.map((product, index) => (
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                <div>
                  <input
                    ...
                    type="text"
                    placeholder={forms.demo.fields[0].placeholder}
                    value={firstName}
                ...
                <div>
                  <input
                    ...
                    className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                    type="text"
                    placeholder={forms.demo.fields[1].placeholder}
                    value={lastName}
                ...
                <div>
                  <input
                    ...
                    className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                    type="email"
                    placeholder={forms.demo.fields[2].placeholder}
                    value={email}
                ...
                <div>
                  <input
                    ...
                    className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                    type="number"
                    placeholder={forms.demo.fields[3].placeholder}
                    value={phone}
              ...
              <div className="my-4">
                <textarea
                  name="message"
                  placeholder={forms.demo.fields[4].placeholder}
              ...
              <div className="my-2 w-1/2 lg:w-2/4">
                ...
                >
                  {forms.demo.submitText}
                </button>
              </div>
            </div>
          </form>
          <div className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-secondary rounded-2xl">
